...
/**
 * Overview page for the current (2026) edition.
 *
 * Rendered at both `/` and `/editions/2026/`: the site has no separate landing page, the
 * root simply shows the current edition. Both routes declare `/` as canonical (see
 * `CURRENT_EDITION_METADATA`), so search engines index one URL and neither needs a
 * redirect. When the next edition launches, point `/` at its overview and give this
 * component a self-referencing canonical under `/editions/2026/`.
 */
export const CURRENT_EDITION_METADATA: Metadata = {
  alternates: { canonical: '/' },
};

export default function Edition2026Overview() {
  return (
    <>
      <Navigation />

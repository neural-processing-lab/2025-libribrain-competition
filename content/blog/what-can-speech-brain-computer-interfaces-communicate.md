...
description: "Progress in thought-to-text with speech decoding BCIs is becoming increasingly difficult to compare. How can we standardise scores and measure progress?"
authors: ["Dulhan Jayalath", "Oiwi Parker Jones"]
tags: ["speech-decoding", "evaluation", "OVMI"]
externalUrl: "https://neural-processing-lab.github.io/blog/what-can-speech-brain-computer-interfaces-communicate/"
...
citations:
  ...
  - id: "mantegna2026libribrain100"
    ...
    journal: "arXiv preprint"
    year: 2026
    url: "https://arxiv.org/abs/2608.25204"
    bibtex: "@article{mantegna2026libribrain100,\n  title={LibriBrain100: One Hundred Hours of Broad and Deep MEG Data for Neural Speech Decoding at Scale},\n  author={Mantegna, Francesco and Jayalath, Dulhan and Elvers, Gereon and Kim, Tasha and Ballyk, Benjamin and Fung, Alex and Cho, SungJun and Kwon, Teyun and Kurth, Luisa and Özdogan, Miran and Landau, Gilad and Somaiya, Pratik and Voets, Natalie and Woolrich, Mark and Parker Jones, Oiwi},\n  journal={arXiv preprint arXiv:2608.25204},\n  year={2026},\n  url={https://arxiv.org/abs/2608.25204}\n}"
  - id: "landau2025pnpl"
  ...
  - id: "ballyk2026physiological"
    ...
    journal: "arXiv preprint"
    year: 2026
    url: "https://arxiv.org/abs/2607.05165"
    bibtex: "@article{ballyk2026physiological,\n  title={Physiological Noise Augmentation Improves Non-Invasive Brain-to-Speech},\n  author={Ballyk, Benjamin and Kwon, Teyun and Özdogan, Miran and Parker Jones, Oiwi},\n  journal={arXiv preprint},\n  year={2026},\n  url={https://arxiv.org/abs/2607.05165}\n}"
  - id: "vanheuven2014subtlex"
    ...
    year: 2014
    url: "https://psycnet.apa.org/record/2014-21737-008"
    doi: "10.1080/17470218.2013.850521"
    bibtex: "@article{vanheuven2014subtlex,\n  title={SUBTLEX-UK: A new and improved word frequency database for British English},\n  author={van Heuven, Walter J. B. and Mandera, Pawel and Keuleers, Emmanuel and Brysbaert, Marc},\n  journal={Quarterly Journal of Experimental Psychology},\n  year={2014},\n  url={https://psycnet.apa.org/record/2014-21737-008},\n  doi={10.1080/17470218.2013.850521}\n}"
  - id: "jayalath2026ovmi"
    title: "A Common Measure of Communication for Speech Brain-Computer Interfaces"
    authors: ["Dulhan Jayalath","Benjamin Ballyk","Oiwi Parker Jones"]
    journal: "arXiv preprint"
    year: 2026
    url: "https://arxiv.org/abs/2609.02887"
    bibtex: "@article{jayalath2026ovmi,\n  title={A Common Measure of Communication for Speech Brain-Computer Interfaces},\n  author={Jayalath, Dulhan and Ballyk, Benjamin and Parker Jones, Oiwi},\n  journal={arXiv preprint},\n  year={2026},\n  url={https://arxiv.org/abs/2609.02887}\n}"
---
![OVMI comparison across reference communication distributions.](/blog/what-can-speech-brain-computer-interfaces-communicate/ovmi_reference_distributions.gif)
...
![OVMI maps study-specific scores onto a shared communication scale.](/blog/what-can-speech-brain-computer-interfaces-communicate/ovmi.png)
...
We appreciate that users may not always have a specific vocabulary or communication distribution in mind. Therefore, we suggest using a standard reference distribution that provides broad coverage. In our work, we use SUBTLEX-UK ([van Heuven et al. 2014](https://psycnet.apa.org/record/2014-21737-008)), a list of word frequencies derived from a large corpus of film and television subtitles. As a result, it captures a lot of what a user may want to say in conversational English speech. While this particular choice is not important, we propose that the community converges on some standard, or set of standard reference distributions, that can be used for comparability.
